...
import { LinkedinPostOverall } from "./linkedinPostOverall";
import { LinkedinPostOrganic } from "./linkedinPostOrganic";
import { LinkedinPostPaid } from "./linkedinPostPaid";

export class LinkedinPost extends Component {
    constructor(props) {
        super(props);
        this.state = {
