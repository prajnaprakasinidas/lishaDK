...
import { FacebookPostOverall } from "./facebookPostOverall";
import { FacebookPostOrganic } from "./facebookPostOverview";
import { FacebookPostPaid } from "./facebookPostPaid";
...
export class FacebookPost extends Component {
    ...
    render() {
        ...
        // let activeBtnClass = (this.state.postsubnav ? 'btn icz-tabbtn': 'btn icz-tabbtn active');
