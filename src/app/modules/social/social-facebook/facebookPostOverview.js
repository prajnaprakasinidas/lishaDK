...
export class FacebookPostOrganic extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        // ! this.state.is_engagement_loaded || !this.state.is_impression_loaded || ! this.state.is_post_metrices_loaded || ! this.state.is_reach_content_loaded || !this.state.is_sentiment_loaded || !this.state.is_video_loaded
        if (!this.state.is_engagement_loaded || !this.state.is_impression_loaded || !this.state.is_post_metrices_loaded || !this.state.is_reach_content_loaded || !this.state.is_sentiment_loaded || !this.state.is_video_loaded) {
            return '<div></div>';
        }
