...
import SearchFilter from '../../../../app/shared/components/searchfilter/searchfilter';


const API_URL = 'https://api1.icogz.com';


export class InstagramPostOrganic extends Component {
    constructor(props) {
        super(props);
        this.state = {
                ...
                <div className="icz-row">
                    <div className="icz-sectioncardwrapper w-100">
                        <Col className="icz-sectioncard d-flex flex-row">
                            <Col className="icz-chartsection" xs={12} lg={8}>
                                <div className="icz-cardheader">
                                    <Col className="icz-cardtitle">
                                        Post Impressions
                                    </Col>
                            ...
                            <Col xs={12} lg={4} className="icz-chartdetailssection">
