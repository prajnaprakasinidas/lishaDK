...
import { TwitterCampaignDropdown } from '../../../shared/components/dropdown/twittercampaigndropdown';
import { TweetCountsDropdown } from '../../../shared/components/dropdown/tweetcountsdropdown';
import { TwitterPerformanceDropdown } from '../../../shared/components/dropdown/twitterperformancedropdown';
import '../social.scss';
...
import DateBasedAxisChart from '../../../shared/components/charts/DateBasedAxisChart';
import BubbleTimelineChart from '../../../shared/components/charts/BubbleTimelineChart';

export class TwitterPostOverall extends Component {
    constructor(props) {
        super(props);
        this.state = {
            ...
            tweets: '[{"y":10,"x":14,"value":59,"y2":-5,"x2":-3,"value2":44},{"y":5,"x":3,"value":50,"y2":-15,"x2":-8,"value2":12},{"y":-10,"x":8,"value":19,"y2":-4,"x2":6,"value2":35},{"y":-6,"x":5,"value":65,"y2":-5,"x2":-6,"value2":168},{"y":15,"x":-4,"value":92,"y2":-10,"x2":-8,"value2":102},{"y":13,"x":1,"value":8,"y2":-2,"x2":0,"value2":41},{"y":1,"x":6,"value":35,"y2":0,"x2":-3,"value2":16}]',
            postsubnav: 'Overall',
            search: '',
    ...
    render() {
        ...
        return (
            <Wrapper>
                ...
                <div className="icz-row">
                    <div className="icz-sectioncardwrapper w-100">
                        <Col className="icz-sectioncard d-flex flex-row">
                            <Col className="icz-chartsection" sm={12} lg={9}>
                                <div className="icz-cardheader">
                                    <Col className="icz-cardtitle">
                                        Tweet Engagement
                                    </Col>
                ...
                <div className="icz-row">
                    <Col className="icz-sectioncardwrapper" lg={12}>
                        <div className="icz-sectioncard">
                            <div className="icz-cardheader d-flex">
                                <Col className="icz-cardtitle">
                ...
                <div className="icz-row">
                    <Col className="icz-sectioncardwrapper" sm={12}>
                        <div className="icz-sectioncard">
                            ...
                            <div className="">
                                <Bubble_chart card_id="tweet_count" card_class="icz-sectionbigchart" graph-data={this.state.bubblechart} />
                            </div>
                        </div>
                    </Col>
                </div>
                    ...
                    <div className="icz-sectioncardwrapper w-100">
                        <div className="icz-sectioncard w-100">
                            <div className="icz-chartsection">
                                ...
                                <div className="">
                                    <DateBasedAxisChart card_id="tweets" card_class="icz-sectionbigchart" graph-data={this.state.tweets} />
                                </div>
                            </div>
                        </div>
                    </div>
