...
export class TwitterPostPaid extends Component {
    constructor(props) {
        super(props);
        this.state = {
                ...
                <div className="icz-row">
                    <div className="icz-sectioncardwrapper w-100">
                        <Col className="icz-sectioncard d-flex flex-row">
                            <Col className="icz-chartsection" lg={9} sm={12}>
                                <div className="icz-cardheader">
                                    <Col className="icz-cardtitle">
                                        Tweet Engagement
                                    </Col>
                            ...
                            <Col lg={3} sm={12} className="icz-chartdetailssection">
