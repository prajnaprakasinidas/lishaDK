...
export class Facebook extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            is_facebook_lead_source_loaded: false,
            total_leads_count: 0,
            top_source_val: 0,
            top_source_name: "",
    ...
    componentDidMount() {
        ...
        this.getFacebookSelectMetrices();
        this.getFacebookDevicematrix();
        this.getLocationTypeData();
        this.getFacebookLeadSource();
        this.getAudianceAgeGender();
    }
    getFacebookLeadSource() {
        const data = {
            'start_date': '2021-10-01',
            'end_date': '2021-12-31',
            'source': 'Facebook',
        }
        const url = "http://127.0.0.1:8000/api/performance/facebook-lead-paichat/"
        fetch(url, {
            method: 'POST',
            ...
            .then((result) => {
                ...
                console.log("Result Facebook Lead Souce = ", result);
                let source_list = result['fb_lead_source_list'];
                ...
                console.log("-------- Facebook Lead Source ----------- ", data_list);
                this.setState({
                    is_facebook_lead_source_loaded: true,
    ...
    getAudianceAgeGender() {
        ...
        const url = "http://127.0.0.1:8000/api/performance/fb-age-group/"
        fetch(url, {
        }
    ...
    getFacebookDevicematrix() {
        const data = {
            'source': 'Google',
        }
        const url = "http://127.0.0.1:8000/api/performance/facebook-device/"
        fetch(url, {
            method: 'POST',
            body: JSON.stringify(data),
            headers: {
    ...
    getMultipleGraphData() {
        ...
        const url = "http://127.0.0.1:8000/api/performance/fb-multiline-graph/"
        fetch(url, {
            method: 'POST',
            body: JSON.stringify(data),
            headers: {
    ...
    getFacebookSelectMetrices() {
        ...
        const url = "http://127.0.0.1:8000/api/performance/fb-select-matrix/"
        fetch(url, {
            method: 'POST',
            body: JSON.stringify(data),
            headers: {
    ...
    getLocationTypeData() {
        ...
        const url = "http://127.0.0.1:8000/api/performance/facebook-location/"
        fetch(url, {
            method: 'POST',
            body: JSON.stringify(data),
            headers: {
    ...
    render() {
        ...
        if (!this.state.is_gender_data_loaded || !this.state.is_facebook_lead_source_loaded || !this.state.is_location_loaded || !this.state.is_social_multiline_loaded || !this.state.is_select_data_loaded || !this.state.is_device_data_loaded) {
            return <div></div>
        }
                                    ...
                                    <Col sm={12} lg={2} className="icz-chartdetailssection">
                                        <div className="icz-detailsdatasection">
                                            <div className="icz-detailsdatatab">
                                                ...
                                                <div className="icz-titlewrapper">
                                                    <div className="icz-title">
                                                        <NumberFormatter Number={((this.state.select_facebook_data['facebook_filter_data'][0]['clicks'] / this.state.select_facebook_data['facebook_filter_data'][1]['impressions']) * 100).toFixed(2)} IsNumber={true} />
                                            ...
                                            <div className="icz-detailsdatatab">
                                                ...
                                                <div className="icz-titlewrapper">
                                                    <div className="icz-title">
                                                        <NumberFormatter Number={this.state.select_facebook_data['facebook_filter_data'][0]['clicks'] + this.state.select_facebook_data['facebook_filter_data'][1]['conversions_money']} IsNumber={true} />
                                            ...
                                            <div className="icz-detailsdatatab">
                                                ...
                                                <div className="icz-titlewrapper">
                                                    <div className="icz-title">
                                                        <NumberFormatter Number={this.state.select_facebook_data['facebook_filter_data'][5]['conversions_money']} IsNumber={true} />
                                                    </div>
                                                    <div className="icz-subtitle">
                                                        Conversions
                                                    </div>
                                            ...
                                            <div className="icz-detailsdatatab">
                                                ...
                                                <div className="icz-titlewrapper">
                                                    <div className="icz-title">
                                                        ...
                                                        <NumberFormatter Number={((this.state.select_facebook_data['facebook_filter_data'][2]['spends_money'] / this.state.select_facebook_data['facebook_filter_data'][5]['conversions_money']) * 100).toFixed(2)} IsNumber={true} />
                                            ...
                                            <div className="icz-detailsdatatab">
                                                ...
                                                <div className="icz-titlewrapper">
                                                    <div className="icz-title">
                                                        <NumberFormatter Number={((this.state.select_facebook_data['facebook_filter_data'][2]['spends_money'] / this.state.select_facebook_data['facebook_filter_data'][3]['app_installed']) * 100).toFixed(2)} IsNumber={true} />
