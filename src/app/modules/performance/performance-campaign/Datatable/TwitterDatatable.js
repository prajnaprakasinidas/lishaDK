...
export class TwitterDatatable extends Component {
  constructor(props) {
    super(props)
    this.state = {
      table_data: data,
  ...
  getTwitterCampaignDataTable() {
    ...
    const url = "http://127.0.0.1:8000/api/performance/twitt-campain-datatable/"
    fetch(url, {
      method: 'POST',
      ...
      .then((result) => {
        ...
        console.log("-------- campaign_list_twitter_datatables ----------- ", data_list);
