...
export class SourceDatatable extends Component {
  ...
  componentDidMount() {
    this.getGoogleCampaignDataTable();

  }

  getGoogleCampaignDataTable() {
    const data = {
      'start_date': '2021-10-01',
      'end_date': '2021-12-31',
    }
    const url = "https://api1.icogz.com/api/performance/summary-table/"
    fetch(url, {
      method: 'POST',
      ...
      .then((result) => {
        let campaign_matrix_list = result['summary_table'];
        ...
        console.log("-------- campaign_list_google_datatables ----------- ", data_list);
