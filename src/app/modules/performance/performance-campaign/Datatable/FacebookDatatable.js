...
export class FacebookDatatable extends Component {
  ...
  getFacebookCampaignDataTable() {
    ...
    const url = "http://127.0.0.1:8000/api/performance/fb-campain-datatable/"
    fetch(url, {
      method: 'POST',
      ...
      .then((result) => {
        ...
        console.log("-------- campaign_list_facebook_datatables ----------- ", data_list);
