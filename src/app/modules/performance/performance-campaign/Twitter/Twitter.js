...
import { TwitterDatatable } from '../Datatable/TwitterDatatable';
...
export class Twitter extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            is_tweet_lead_source_loaded: false,
            total_leads_count: 0,
            top_source_val: 0,
            top_source_name: "",
    ...
    componentDidMount() {
        this.getTwitterLeadSource();
        this.getLocationTypeData();
        this.getTwitterDevicematrix();
        this.getMultipleGraphData();
        this.getTwitterSelectMetrices();
    }
    getTwitterLeadSource() {
        const data = {
            'start_date': '2021-10-01',
            'end_date': '2021-12-31',
            'source': 'Twitter',
        }
        const url = "http://127.0.0.1:8000/api/performance/twitter-lead-paichat/"
        fetch(url, {
            method: 'POST',
            ...
            .then((result) => {
                ...
                console.log("Result Twitter Lead Souce = ", result);
                let source_list = result['twitter_lead_source_list'];
                ...
                this.setState({
                    is_tweet_lead_source_loaded: true,
    ...
    getLocationTypeData() {
        ...
        const url = "http://127.0.0.1:8000/api/performance/twitter-location/"
        fetch(url, {
            method: 'POST',
            body: JSON.stringify(data),
            headers: {
    ...
    getTwitterDevicematrix() {
        const data = {
            'source': 'Twitter',
        }
        const url = "http://127.0.0.1:8000/api/performance/twitter-device/"
        fetch(url, {
            method: 'POST',
            body: JSON.stringify(data),
            headers: {
    ...
    getMultipleGraphData() {
        ...
        const url = "http://127.0.0.1:8000/api/performance/twitter-multiline-graph/"
        fetch(url, {
            method: 'POST',
            body: JSON.stringify(data),
            headers: {
    ...
    getTwitterSelectMetrices() {
        ...
        const url = "http://127.0.0.1:8000/api/performance/twitt-select-matrix/"
        fetch(url, {
            method: 'POST',
            body: JSON.stringify(data),
            headers: {
            ...
            .then((result) => {
                this.setState({
                    ...
                    select_twitter_data: result
                });
            })
    }

    render() {
        if (!this.state.is_tweet_lead_source_loaded || !this.state.is_select_data_loaded || !this.state.is_social_multiline_loaded || !this.state.is_location_loaded || !this.state.is_device_data_loaded) {
            return <div></div>
        }
        ...
        let otherDevices;
        // let pragya = 'asd';
        { this.state.device_data['device_list'][3] ? otherDevices = this.state.device_data['device_list'][3] : otherDevices = 0 }
        // if (this.state.device_data['device_list'][3] in this.state.device_data['device_list']) {
        //     pragya = "das"
        //     alert('pragya', pragya);
        // } else {
        //     pragya = "das das"
                                ...
                                <Col sm={12} lg={2} className="icz-chartdetailssection">
                                    <div className="icz-detailsdatasection">
                                        <div className="icz-detailsdatatab">
                                            ...
                                            <div className="icz-titlewrapper">
                                                <div className="icz-title">
                                                    <NumberFormatter Number={((this.state.select_twitter_data['twitter_filter_data'][0]['clicks'] /
                                                        this.state.select_twitter_data['twitter_filter_data'][0]['impressions']) * 100).toFixed(2)
                                                    } IsNumber={true} />
                                        ...
                                        <div className="icz-detailsdatatab">
                                            ...
                                            <div className="icz-titlewrapper">
                                                <div className="icz-title">
                                                    <NumberFormatter Number={this.state.select_twitter_data['twitter_filter_data'][0]['clicks'] + this.state.select_twitter_data['twitter_filter_data'][0]['conversions_money']} IsNumber={true} />
                                        ...
                                        <div className="icz-detailsdatatab">
                                            ...
                                            <div className="icz-titlewrapper">
                                                <div className="icz-title">
                                                    ...
                                                    <NumberFormatter Number={this.state.select_twitter_data['twitter_filter_data'][0]['conversions_money']} IsNumber={true} />
                                                </div>
                                                <div className="icz-subtitle">
                                                    Conversions
                                                </div>
                                        ...
                                        <div className="icz-detailsdatatab">
                                            ...
                                            <div className="icz-titlewrapper">
                                                <div className="icz-title">
                                                    ...
                                                    <NumberFormatter Number={((this.state.select_twitter_data['twitter_filter_data'][0]['spends_money'] / this.state.select_twitter_data['twitter_filter_data'][0]['conversions_money']) * 100).toFixed(2)} IsNumber={true} />
                                        ...
                                        <div className="icz-detailsdatatab">
                                            ...
                                            <div className="icz-titlewrapper">
                                                <div className="icz-title">
                                                    ...
                                                    <NumberFormatter Number={((this.state.select_twitter_data['twitter_filter_data'][0]['spends_money'] / this.state.select_twitter_data['twitter_filter_data'][0]['app_installed']) * 100).toFixed(2)} IsNumber={true} />
